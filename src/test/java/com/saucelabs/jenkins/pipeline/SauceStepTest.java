...
class SauceStepTest {
    ...
    @Test
    void sauceTest() throws Exception {
    ...
    @Test
    void sauceJWTTest() throws Exception {
        String credentialsId =
    ...
    @Test
    void sauceConnectWithGlobalOptionsTest() throws Exception {
        String credentialsId =
            SauceCredentials.migrateToCredentials("fakeuser", "fakekey", null, "unittest");
    ...
    @Test
    void sauceConnectWithoutSauceTest() throws Exception {
        WorkflowJob p =
