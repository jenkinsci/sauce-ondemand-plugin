...
class SauceEnvironmentUtilTest {

    @Test
    void generateTunnelName_should_use_the_project_name_in_the_tunnel_id() {
    ...
    @Test
    void generateTunnelName_should_sanitize_the_project_name() {
    ...
    @Test
    void generateTunnelName_should_include_an_epoch_timestamp() {
